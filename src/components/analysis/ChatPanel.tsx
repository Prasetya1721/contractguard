...
export default function ChatPanel({ analysis }: ChatPanelProps) {
  const { messages, isOpen, openChat, closeChat, sendUserMessage, clearSession } =
    useAgent(analysis);
  ...
  // Inisialisasi pesan selamat datang saat panel pertama dibuka
  useEffect(() => {
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 bg-brand-600 text-white rounded-t-2xl shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold leading-tight">ContractGuard AI</p>
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-white/20 transition-colors hidden md:flex"
        ...
        {!minimized && (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
              {/* Quick starters jika belum ada chat */}
              {messages.length === 0 && (
                <div className="space-y-3">
                  <p className="text-xs text-gray-500 text-center">Tanyakan tentang kontrak Anda:</p>
            ...
            <div className="px-3 py-1.5 bg-amber-50 border-t border-amber-100">
              <p className="text-[10px] text-amber-700 text-center leading-tight">
                ⚠️ AI Agent bukan pengganti nasihat hukum profesional
              </p>
            </div>
            ...
            <div className="px-3 py-3 bg-white border-t border-gray-200 rounded-b-2xl shrink-0">
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  placeholder="Tanyakan tentang kontrak ini..."
                  rows={1}
                  disabled={isTyping}
                  className={cn(
                    'flex-1 resize-none text-sm px-3 py-2 rounded-xl border border-gray-300 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition',
